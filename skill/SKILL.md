...
- `frames setup` downloads the current asset archive from `https://cdn.macstories.net/AppleFrames40.zip`.
...
The current v4 asset bundle used by `frames` 1.2.7 includes these primary families:
